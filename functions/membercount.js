  ...
  let countRefresh = async function (guild) {
    ...
    for (let i in settings.channels) {
      ...
      if (channel.channel && channel.channel.type === 2) {
        ...
        guild.channels.get(channel.channel.id).edit({
          name: string
        }, "Member count");
      }
    }
    ...
    generator: async (msg, args) => {
      ...
      switch (args[0] ? args[0].toLowerCase() : "") {
        case "setup":
          ...
          temp = (settings.channels.mCountTotal.channel ? guild.channels.get(settings.channels.mCountTotal.channel.id) : null) || await guild.createChannel("Member count", 2, "Member count", settings.channels.mcCategory.channel.id);
        ...
        case "set":
          switch (args[1] ? args[1].toLowerCase() : "") {
            ...
            case "human":
              ...
              if (temp === "") {
                bot.send(msg, "**you didnt tell me what to set it to**\n" +
